...
<body>
<?php if (empty($_SESSION['ss_admin_nhanvien'])) { ?>
...
<div class="container">
	<div class="row" style="margin-left: 10px;">
		<?php if (empty($dangky)) { ?>
		<form action="?controller=dangky" method="post" class="col-sm-4">
			<div class="form-group">
				<label>Họ tên:</label><?php if (isset($error['fullname'])){ ?> <span style="color: red;"><?php echo $error['fullname'];?></span><?php } ?>
				<input class="form-control" type="text" name="fullname" value="<?php echo (isset($fullname))?$fullname:'' ?>">
			</div>
			<div class="form-group">
				<label>Tên tài khoản:</label><?php if (isset($error['username'])){ ?> <span style="color: red;"><?php echo $error['username'];?></span><?php } ?>
			...
			<div class="form-group">
				<label>Nhập lại mật khẩu:</label><?php if (isset($error['repassword'])){ ?> <span style="color: red;"><?php echo $error['repassword'];?></span><?php } ?>
				<input class="form-control" type="password" name="repassword" value="<?php echo (isset($repassword))?$repassword:'' ?>">
			</div>
			<div class="form-group">
				<input style="background: #0c1a1e; color: white;"  class="btn" type="submit" name="btn-dangky" value="Đăng ký">
				<input style="background: #0c1a1e; color: white;"  class="btn" type="reset" name="" value="Xoá">
				...
				<h2>Chào mừng <b><?php echo $dangky[0]['fullname'];?></b> đã đến với HANOIMAC</h2>
				<h2>Hãy đăng nhập và tiếp tục sử dụng dịch vụ!</h2>
					<?php } ?>
...
<?php } else {echo "Đại vương đã đăng nhập thành công rồi mà!";} ?>
</body>
</html>