...
<div class="container" style="margin-top: 5px;">
  <div class="row">
    <div class="col-sm-9">
      <p id="tieude"><?php echo $product[0]['full_name'] ?></p>
    </div>   
  </div>

  <div class="row" id="sanpham">
    <div class="col-sm-5">
      <img src="<?php echo $product[0]['img_link'] ?>">
    </div>
  

    <div class="col-md-5">
      <p id="price"><?php echo $db->currency_format($value['price']) ?> VNĐ <span>Giá cũ: <?php echo $db->currency_format($value['old_price'])?> VND</span></p>
      <a style="background: #0c1a1e; line-height: 40px; width: 80%" href="?controller=add_giohang&id=<?php echo $value['id'] ?>" class="btn">THÊM GIỎ HÀNG</a>
      <a href="" class=" btn">TRẢ GÓP <br><i>(Xét duyệt qua điên thoại)<i></a>
      <a href="" class=" btn">TRẢ GÓP 0% QUA THẺ <br><i>(Visa Master JCB)</i></a>
      <p style="color: red; margin-top: 10px;">
        * Thanh toán Online/ Miễn phí giao hàng thu tiền <br>
        * Thu cũ đổi mới/ Hỗ trợ trọn đời
      </p>
      <p id="content"><?php echo $product[0]['details'] ?></p>
    </div>
  </div>
