...
<head>
	...
	<title>Reeder – Phần mềm đọc tin tức từ RSS</title>
...
<div class="container post">
	<div class="row col-md-9 ">
		<h2>Reeder – Phần mềm đọc tin tức từ RSS</h2>
		<p>
			Reeder giúp bạn Feed tin từ các tờ báo có hỗ trợ RSS để tập trung về một chỗ đọc rất tiện lợi
			<br>
			Bài viết được chia sẻ bởi bạn Hai Do Duc trên group Maclife và đồng bọn
		</p>
		<img width="100%" src="../img/imgblog/blog2.1.jpg">
		Hello các bác, hưởng ứng tinh thần chia sẻ app hay của bác Vũ Nguyễn Anh Tuấn thì nay em xin chia sẻ với các bác 1 phần mềm đọc tin mà em đã sử dụng từ rất lâu rồi.<br><br>

Phần mềm: Reeder.<br><br>

-<b>Giới thiệu chung</b>: là phần mềm tổng hợp tin RSS từ các nguồn báo mà các bác thêm vào. Ngoài ra có thể kết nối các tài khoản sẵn có như Feedly, Minimal Reader...<br><br>

-<b>Lý do sử dụng</b>: em có nhiều nguồn tin từ các trang báo khác nhau cần đọc, việc chuyển giữa các trang báo khác nhau tốn thời gian, dễ đọc sót tin,...<br><br>

-<b>Cách sử dụng</b>: các trang báo đều có link RSS được ghim ở trên trang, ví dụ trang chủ Vnexpress là https://vnexpress.net/rss/tin-moi-nhat.rss, The Verge là https://www.theverge.com/rss/index.xml, các bác chỉ cần thêm link này vào phần mềm là xong. Hoặc đơn giản như em là kết nối tài khoản Feedly mà trước đó em đang dùng vào.<br><br>

-<b>Ưu điểm</b>: giao diện đẹp, hiệu ứng mượt mà, có cả ở macOS lẫn iOS. Tin tổng hợp ở 1 chỗ rất tiện, tin nào đọc xong sẽ được ẩn đi.<br><br>

-<b>Nhược điểm</b>: ban đầu các bác sẽ hơi gặp bối rối ở phần thêm nguồn trang, giá khá là cao (Reeder 5: 109k cho bản iOS, 219k cho bản macOS). Hy vọng sẽ sớm có bản vitamin trên Maclife cho anh em test ????<br><br>

<b>Link tải</b>: <a href="https://reederapp.com/">https://reederapp.com/</a>  <br><br>
		<img width="100%" src="../img/imgblog/blog2.2.jpg">
