	...
	<div class="row" style="margin-top: -20px">
		...
		switch ($controller) {
			case 'thanhtoangiohang':?>
				<div class="col-sm-5 thanhtoan" style="margin-left: 50px; ;">
		<h2>Thanh toán sản phẩm</h2>

		<form action="?controller=thanhtoan" method="post">
			<div >
			...
			<div >
				<button style="background: #0c1a1e; color: white; margin-top: 20px" type="submit" name="btn_xacnhan" class="btn btn-md col-md-3 ">Xác nhận</button>
				<button style="background: #0c1a1e; color: white; margin-left: 1px; margin-top: 20px" type="reset" class="btn btn-md col-md-3 ">Huỷ</button>
			</div>
		</form>
		</div>
			<?php break;
			case 'thanhtoanthanhcong':?>
				<h2 style="margin-left: 50px; margin-top: 50px;">Xác nhận thông tin thanh toán THÀNH CÔNG!</h2>
				<h2 style="margin-left: 50px; margin-bottom: 100px;">CẢM ƠN QUÝ KHÁCH!</h2>
			<?php break;
