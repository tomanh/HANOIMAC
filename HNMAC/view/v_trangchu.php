...
<div class ="container">
	...
	<div class="row glyphicon2">
		...
		<div class="col-sm-12">
			<p class="col-sm-3" style="background: #0c1a1e; height: 45px;line-height: 45px; margin-bottom: 0;"><a style="margin-left: -15px" class="col-sm-1" href="?controller=trangchu"><span style="color: white;" class="glyphicon glyphicon-home"></span></a><span class="col-sm-10" style="font-size: 16px; color: white;">DANH MỤC SẢN PHẨM</span><span style="color: white; margin-left: -10px;" class="glyphicon glyphicon-menu-down"></span></p>
 		 ...
 		 <!-- Indicators -->
			...
			<div class="carousel-inner">
				<div class="item active">
					<a href="?controller=subindex&sub=banner"><img style="" src="../img/imgbanner/3.jpg"></a>
				</div>

				<div class="item">
					<a href="?controller=subindex&sub=banner"><img style="" src="../img/imgbanner/1.1.jpg"></a>
				</div>

				 <div class="item">
				 	<a href="?controller=subindex&sub=banner"><img src="../img/imgbanner/2.jpg"></a>
				 </div>
				 <div class="item">
				   	 <a href="?controller=subindex&sub=banner"><img src="../img/imgbanner/4.jpg"></a>
				</div>
			</div>
	...
	<div class="row" id="menu2">
		<div class="col-sm-3" style="background: #E6E6E6; height: 42px; margin-left: 15px;">
			<p>TIN MỚI <span class="glyphicon glyphicon-info-sign"></span></p>
		</div>
	<!--PHẦN 4.1 (Menu)-->
		<div class="col-sm-9" id="phan4-1" style=" margin-left: -15px;">
			<ul style="height: 41px; line-height: 41px; border: 0px;" class="nav nav-tabs">
				<li style="margin-left: -30px"><a href="?controller=tatcasanpham">TẤT CẢ SẢN PHẨM</a></li>
	...
	<div class="row" style="margin-top: 2px;">
		<div class="col-sm-3" id="tintuc" >
			<div style="border-top: 1px solid #bbb; border-left: 1px solid #bbb; border-right: 1px solid #bbb;">
				<ul class="media-list">
				<li class="midea">
		...
		<!--PHẦN 4.3 SẢN PHẨM-->
		<div id="sanpham" class="col-sm-9" style="margin-top: 10px; margin-left: -30px;">
...
<!--PHẦN 5 (Địa chỉ sdt)-->
	<div class="col-sm-12 phan5" style="margin-top: 0px;">
