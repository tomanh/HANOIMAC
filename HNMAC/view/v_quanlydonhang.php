...
<?php if($_SESSION['chucvu']=='Quản lý'||$_SESSION['chucvu']=='Nhân viên'){ ?>
...
<div class="container">
	<div class="row col-sm-12">
		...
		<div class="panel" style="border: 1px solid #0c1a1e;">
			<div style="background:#0c1a1e; color: white; font-size: 16px;" class="panel-heading">Quản lý hệ thống đơn hàng HANOIMAC</div>
			...
			<div class="panel-body">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td style="width: 4%; text-align: center;"><?php echo $value['id'] ?></td>
							...
							<td style="width: 8%"><?php echo $value['email'] ?></td>
							<td style="width: 10%"><?php echo $db->currency_format($value['amount'],'đ');?></td>
							<td style="width: 15%; color: red; font-weight: bold;"><?php echo $value['status'] ?></td>
							<td style="width: 18%">
								<a style="width: 48%; background: #0c1a1e; color: white;" href="?controller=xacnhandonhang&method=xacnhan&id=<?php echo $value['id'] ?>" class="btn btn-sm">Xác nhận</a>
								<a style="width: 48%; background: #FB5807; color: white;" href="?controller=xacnhandonhang&method=huybo&id=<?php echo $value['id'] ?>" class="btn btn-sm">Huỷ bỏ</a>
							</td>
							<td>															
								<a style="font-size:18px; color: black;" href="?controller=xacnhandonhang&method=xoa&id=<?php echo $value['id'] ?>"><i class="far fa-trash-alt"></i></a>
							</td>					
						</tr>
					</tbody>
					<?php } ?>					
