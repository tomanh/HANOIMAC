...
<head>
	...
	<title>Apple đã khắc phục lỗi hao mòn SSD trên Macbook M1</title>
...
<div class="container post">
	<div class="row col-md-9 ">
		<h2>Apple đã khắc phục lỗi hao mòn SSD trên Macbook M1</h2>
		<p>
			Thời gian qua có rất nhiều thông tin về việc SSD của Macbook M1 bị hao mòn rất nhanh. Việc SSD bị hao mòn quá nhanh sẽ khiến ổ cứng giảm tuổi thọ đi rất nhanh. Trường hợp xấu hơn một chiếc SSD bị khấu hao quá nhiều sẽ khiến máy tính của bạn chạy chậm hoặc tệ hơn là dữ liệu trong máy sẽ bị mất. Vậy đâu là cách khắc phục, cùng mình tìm hiểu dưới đây nhé.
		</p><br>
		<h3>Hao mòn SSD trên Mac M1 là gì?</h3>
		<p>Vấn đề hao mòn SSD trên Macbook M1 được rất nhiều người bàn luận trong suốt thời gian qua. Như các bạn đã biết những máy sử dụng chip M1 sẽ dùng bộ nhớ chung unified memory, những thành phần CPU, GPU, RAM hay SSD sẽ lấy dữ liệu từ bộ nhớ chung và điều đó sẽ  giúp máy trở nên nhanh chóng hơn.</p>
		<img width="100%" src="../img/imgblog/blog1.1.png">
		<p>Đa số những chiếc SSD hiện nay sử dụng cơ chế TBW (Total Bytes Written) để đo tuổi thọ của SSD. Thường thì SSD hiện hay sẽ rơi vào khoảng 150TB đến 200TB, đôi khi là 250TB. Khi SSD của bạn đọc vượt quá mức này thì nó sẽ trở nên không ổn định, nhẹ thì không thể ghi thêm dữ liệu, còn nặng hơn thì không đọc được dữ liệu.
			<br><br>
		Với dung lượng SSD trên thì tuổi thọ trung bình của chúng sẽ rơi vào khoảng 10 năm. Nhưng hiện tại, nhiều phần mềm của bên thứ 3 đo được rằng là những máy sử dụng chip M1 sẽ khiến SSD hoạt động nhiều hơn bình thường. Với thông số như các phần mềm báo cáo thì sẽ chỉ khoảng 2 năm thì SSD trên Macbook M1 sẽ đọc hết và xảy ra lỗi. Điều này khiến nhiều người dùng lo lắng.
			<br><br>
		Nếu các bạn đang sử dụng Macbok chip M1 hay chip Intel muốn kiểm tra xem SSD của mình đã hao mòn bao nhiêu ​​thì có thể tham khảo ứng dụng DriveDx - ứng dụng phổ biến có thể kiểm tra tình trạng SSD.</p>
		<img width="100%" src="../img/imgblog/blog1.2.jpg">
		<h2>Tổng kết</h2>
		<br>
		<p>Với một số bài kiểm tra ở trên và các nguồn thông tin mình tổng hợp được thì bạn đừng quá lo lắng trong việc SSD của mình bị hao mòn. Apple luôn đặt trải nhiệm người dùng lên hàng đầu vì vậy các phiên bản mới dần dần sẽ được cải thiện đơn cử như bạn chỉ cần update macOS mới nhất là việc SSD bị hao mòn đã được giảm đi đáng kể.
			<br><br>
		Apple cũng đã công bố họ cần 2 năm để hoàn thành việc chuyển đổi nhưng thiết bị của hãng qua dùng chip Apple Silicon và cũng trong khoảng thời gian đó các nhà phát triển phần mềm có thể tối ưu các ứng dụng native cho Apple Silicon. Hiện tại thì đã có rất nhiều các ứng dụng đã Native trên Macbook M1 bạn có thể tham khảo tại đây. Bạn cũng nên dùng các phần mềm đã Native để giúp máy đỡ phải đọc quá nhiều dữ liệu đồng thời giúp máy tăng tuổi thọ của máy.
			<br><br>
		Cảm ơn bạn đã theo dõi bài viết, nếu có bất kì thắc mắc nào hãy để lại bình luận bên dưới được giải đáp nhé. Hiện tại, Hnmac đang có chương trình khuyến mãi giảm đến 15% Macbook Pro M1 các bạn đừng bỏ lỡ nhé.</p>
	</div>
</div>
<!--PHẦN 5 (Địa chỉ sdt)-->
<div>
