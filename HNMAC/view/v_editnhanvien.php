		...
		<div class="panel" style=" border: 1px solid #0c1a1e; width: 65%;float: right;">
			...
			<div class="panel-body">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<form action="?controller=xulynhanvien&method=edit&id=<?php echo $_GET['id'] ?>" method="post">			
							...
							<td style="width: 20%">
								<input class="btn" style="width: 100%; height: 27px; line-height: 13px; background:  #2E6EC8; color: white" type="submit" name="" value="Sửa">
							</td>
							</form>						
						</tr>
					</tbody>					
