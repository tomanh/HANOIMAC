...
<div class ="container">
	...
	<div class="row"  style="height: 80px;">
		...
		<!--PHẦN 2.1 Logo-->
		<div class=" col-sm-2">
			<a href="?controler=trangchu"><img width="250px" src="../img/machn.png"></a>
		</div>
		<!--PHẦN 2.2 Search-->
			...
			<ul class="media-list">
				<li class="midea">
					<div class="media-left">
						<a href=""><img src="../img/khuyenmai.jpg" class="media-object" width="160" height="120"></a>
					</div>
					<div class="media-body">
						<a href=""><i><b>Ở  đây sẽ chứa các thông tin khuyến mại của trang web. Ở  đây sẽ chứa các thông tin khuyến mại của trang web. Ở  đây sẽ chứa các thông tin khuyến mại của trang web. Đón chào mùa hè siêu sale 50% tất cả các mặt hàng từ ngày ... tới ngày ... mại dzô!!!</b><i></a>
					</div>
				</li>
				<li class="midea">
					<div class="media-left">
